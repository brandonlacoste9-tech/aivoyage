...
export const metadata: Metadata = {
  title: "Explore destinations — AI trip ideas",
  description: `Browse destinations and country facts on ${APP_NAME}. Plan day-by-day AI itineraries for Kyoto, Lisbon, Bali, Rome, Tokyo, Paris, and more.`,
  alternates: { canonical: "/explore" },
  openGraph: {
    title: `Explore destinations · ${APP_NAME}`,
    description:
      "Search countries, browse featured cities, and start an AI day-by-day itinerary.",
  },
...
export default async function ExplorePage() {
  ...
  const inventHref = user ? "/trips/new" : "/auth/sign-up";

  return (
    <div className="min-h-screen bg-paper">
      <SiteHeader />
      <main className="mx-auto max-w-7xl space-y-10 p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            ...
            <h1 className="mt-1 font-display text-3xl font-semibold tracking-tight sm:text-4xl">
              Explore destinations for AI trip plans
            </h1>
            <p className="mt-2 max-w-xl text-[var(--muted)]">
              Search any country for live facts and trip ideas — or pick a
              curated city below and start a day-by-day AI itinerary on{" "}
              {APP_NAME}.
            </p>
          </div>
          <Button asChild variant="accent">
            <Link href={inventHref}>
              Invent your own
          ...
          <div className="mb-5 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-[var(--muted)]">
                Hand-picked destinations with photo guides and planning tips
              </p>
            </div>
          </div>
            ...
            {DESTINATIONS.map((d, i) => (
              ...
              >
                ...
                >
                  <Image
                    src={d.image}
                    alt={`Plan a trip to ${d.name} with AI`}
                    fill
                    sizes={i === 0 ? "66vw" : "25vw"}
